...
contract LiquidityMigrator{
    ...
    constructor(
        ...
        function deposit(uint amount) external {
            require(migrationDone == false,"Migraton Already done!");
        ...
        function  claimLpTokens() external{
            require(unclaimedBalance[msg.sender] >= 0, 'No unclaimed Balance');
            require(migrationDone == true,'Migration not done yet');
            uint amountToSend = unclaimedBalance[msg.sender];
